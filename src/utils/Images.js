...
import rickRoll from '/img/rick-roll.gif'
...
const works = [spectrum, orsay, metamorph, mesh, rickRoll]
...
import spectrum from '/img/spectrum.png'
import orsay from '/img/orsay.png'
import metamorph from '/img/media.png'
import mesh from '/img/mesh.png'
import rickRoll from '/img/rick-roll.gif'

import cinema from '/img/PP.png'
import music from '/img/vietseed.png'
import photo from '/img/IELTS.png'
import museum from '/img/museum.gif'
import games from '/img/games.gif'
